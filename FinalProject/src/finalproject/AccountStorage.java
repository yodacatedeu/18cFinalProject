/*
 Class that stores, sorts and searches through the account objects
 utilizes quick sort and binary search of an ArrayList, and uses a hashmap
 */
...
//        }
    ...
    public void add(Account accnt) {
       if (pinsAndNames.get(accnt.getPin()) != null || accnt.getPin() == 0) {
