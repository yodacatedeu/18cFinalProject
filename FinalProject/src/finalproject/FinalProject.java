...
Program simulates an ATM

This is the main
Login by entering a user's pin, 
choose to either withdraw, deposit 
or tranfer money between the user's 
...
public class FinalProject {
    ...
    public static void main(String[] args) {
        ...
        list.add(new Account("Kyle Bromley", checking, savings, 1234));
        list.add(new Account("Aron Bauer", checking, savings, 4321));
        list.add(new Account("Julio Vasquez", checking, savings, 2345));
